...
to setup-round
  ...
  [
    ...
    ifelse number = 1 [setxy 3 13][
      ifelse number = 2 [setxy 9 13][
        ifelse number = 3 [setxy 16 13][
          setxy 22 13]
      ]
    ]
  ]
...
;  profiler:start
  ...
  set resource1 n-values 241 [0] set resource2 n-values 241 [0] set resource3 n-values 241 [0]
  set resource4 n-values 241 [0] set resource5 n-values 241 [0] set resource6 n-values 241 [0]
  set resource7 n-values 241 [0] set resource8 n-values 241 [0] set resource9 n-values 241 [0]
  set trust1 n-values 241 [0] set trust2 n-values 241 [0] set trust3 n-values 241 [0]
  set trust4 n-values 241 [0] set trust5 n-values 241 [0] set trust6 n-values 241 [0]
  set trust7 n-values 241 [0] set trust8 n-values 241 [0] set trust9 n-values 241 [0]
...
<experiments>
  ...
  <experiment name="testingminimal2" repetitions="100" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>reset-timer
manyruns</setup>
    <timeLimit steps="2162"/>
    <metric>fitness</metric>
